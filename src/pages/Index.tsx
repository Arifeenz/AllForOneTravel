      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-800 mb-6 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-600"> All For One Tour</span>
          </h1>
        ...
        {/* Tour Section */}
        <div className="mt-20">
          <h2 className="text-3xl font-bold text-gray-800 text-center mb-12">Featured Tour Packages</h2>
        ...
        <div className="text-center mt-20">
          <div className="bg-white rounded-2xl shadow-lg p-8 max-w-2xl mx-auto border border-cyan-100">
            ...
            <p className="text-gray-600 mb-6">Have questions about Phuket? Our local experts are here to help you plan the perfect trip.</p>
            <a
              href="/question"
